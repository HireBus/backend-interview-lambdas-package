...
type APIGatewayEventWithIdTokenData<TEvent = undefined> =
  APIGatewayEvent<TEvent> & {
    idTokenData: IdTokenData;
  };

type APIGatewayEventWithIdTokenDataAndEvent<TEvent = undefined> =
  TEvent extends undefined
...
> = TType extends "public"
  ...
  : APIGatewayEventWithIdTokenDataAndEvent<
      EventParams<TBody, THeaders, TPathParams, TQuery>
    >;
...
> = (
  ...
  | ReturnType<typeof makeAPIResponse>;
...
>({
  ...
  let resultHandler = middy(handler as unknown as Handler)
